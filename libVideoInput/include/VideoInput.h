...
/** Wrapper for generic video inputs. You may want to use VideoInputFactory to create one and than use this generic interface.

	Use init() to initialize it using a camera with given ID or an image or video file.
